...
public class StackView<T extends StackView.Renderable> extends Canvas {
	...
	public void clearSpriteCaches() {
		for (T renderable : renderables) {
			if (renderable instanceof it.unibo.pss.view.sprites.SpriteCache) {
				((it.unibo.pss.view.sprites.SpriteCache) renderable).reloadSprites();
			}
		}
	}
	...
	public interface Renderable {
		void render(javafx.scene.canvas.GraphicsContext gc, 
				it.unibo.pss.controller.observer.ModelDTO modelDTO,
				it.unibo.pss.view.handlers.PanZoomHandler camera, 
