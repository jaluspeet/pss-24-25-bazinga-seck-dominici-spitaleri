package it.unibo.bazinga.model;
...
import it.unibo.bazinga.model.entity.EntityManager;
import it.unibo.bazinga.model.world.World;
import it.unibo.bazinga.model.world.WorldManager;
...
public class Model {
	...
	private String getEntityName(BasicEntity e) {
		if (e instanceof it.unibo.bazinga.model.entity.SheepEntity) { return "sheep" + e.getId(); } 
		else if (e instanceof it.unibo.bazinga.model.entity.WolfEntity) { return "wolf" + e.getId(); } 
		else if (e instanceof it.unibo.bazinga.model.entity.PlantEntity) { return "plant" + e.getId(); } 
